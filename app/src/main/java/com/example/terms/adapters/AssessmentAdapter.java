...
import com.example.terms.views.AssessmentDetailsActivity;
import com.example.terms.views.CourseDetailsActivity;

import java.util.ArrayList;
import java.util.List;

public class AssessmentAdapter extends RecyclerView.Adapter<AssessmentAdapter.Views> {

    List<Assessment> terms=new ArrayList<>();
    Context context;
    ...
    public void setTerms(List<Assessment> terms){
        this.terms=terms;
